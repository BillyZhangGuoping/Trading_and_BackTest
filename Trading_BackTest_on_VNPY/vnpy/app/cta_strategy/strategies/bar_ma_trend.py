...
class BarMaTrendStrategy(CtaTemplate):
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, vt_local, setting):
        ...
        self.period_list = [2,5,10,30,60,90,120]
        ...
        self.exit_open_timeAM = time(hour=14, minute=40)
        self.exit_open_timeNI = time(hour=22, minute=40)
    ...
    def on_time_bar(self, bar: BarData):
        ...
        ema_result = []
        for ema_length in self.period_list:
