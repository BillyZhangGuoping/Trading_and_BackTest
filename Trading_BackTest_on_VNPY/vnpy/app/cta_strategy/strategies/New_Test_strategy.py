...
class New_Test_strategy(CtaTemplate):
    """"""
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, vt_local, setting):
        ...
        self.bg = BarGenerator(self.on_bar,1,self.on_window_bar)
    ...
    def on_trade(self, trade: TradeData):
        ...
        self.update_setting({'init_pos': self.pos, 'init_entry_price': self.entry_price})
