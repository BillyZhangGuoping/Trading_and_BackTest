...
if __name__ == '__main__':
    ...
    argumentlist = [
        ...
        {"startDate": datetime(2019, 1, 8), "endDate": datetime(2022, 12, 15), "vt_symbol": "ag9999.SHFE"}
    ...
    for argument in argumentlist:
        bts.runBatchTestExcecl(startDate = argument["startDate"],endDate = argument["endDate"],vt_symbol = argument["vt_symbol"],mutiple= False)