...
def check_trading_period(current_time,dayofweek):
    ...
    trading = False
    # if (
    #       (current_time >= time(8, 20) and current_time <= time(12, 30))
    #       or (current_time >= time(12, 50) and current_time <= time(15, 59))
    #       or (current_time >= time(20, 20) or current_time <= time(3, 59))
    # ):
    #   # if dayofweek < 5:
    #       trading = True
    ...
    closeTime_morning_end = time(8,53)
    closeTime_mid_start = time(13,20)
    closeTime_mid_end = time(13,23)
    closeTime_night_start = time(20,50)
    closeTime_night_end = time(20,53)
