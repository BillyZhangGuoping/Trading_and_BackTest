...
EXCHANGE_CTP2VT: Dict[str, Exchange] = {
    ...
    "DCE": Exchange.DCE,
    "INE": Exchange.INE,
    "GFEX": Exchange.GFEX           # Guozhou Trade System": Exchange.INE
}
...
class CtpTdApi(TdApi):
    ...
    def onRspQryInvestorPosition(self, data: dict, error: dict, reqid: int, last: bool) -> None:
        ...
        if contract:
            ...
            # Billy add
            position.useMargin += round(data["UseMargin"],2)
            #end Billy add
    ...
    def onRspQryTradingAccount(self, data: dict, error: dict, reqid: int, last: bool) -> None:
        ...
        account: AccountData = AccountData(
            ...
            BankTransfer = data['Deposit'] - data["Withdraw"],
            CurrentProfit = data["Balance"] - data["PreBalance"] - data['Deposit'] + data["Withdraw"],
            CurrMargin = data['CurrMargin'],
            CurrMarginPrecent = data['CurrMargin']*100.0/data["Balance"],
    ...
    def send_order(self, req: OrderRequest) -> str:
        ...
        # if req.type not in ORDERTYPE_VT2CTP or req.type == OrderType.FAK:
